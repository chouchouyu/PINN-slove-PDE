...
def main():
    ...
    try:
        ...
        learning_rate1 = best_params.get('learning_rate1', 1e-3) * 0.1  # 减小学习率10倍以提高稳定性
        N_Iter2 = best_params.get('n_iter2', 3000)  # 默认3000次
        learning_rate2 = best_params.get('learning_rate2', 1e-5) * 0.1  # 减小学习率10倍以提高稳定性
        ...
        # 将参数传递给run_model函数
        # 运行模型训练和评估
        final_model = run_model(model, N_Iter1, learning_rate1, N_Iter2, learning_rate2, Xi, T, D, M)
